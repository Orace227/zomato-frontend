      ...
      <div className=" container-md ">
        <div className="flex flex-col mt-5 md:flex md:flex-row">
          <div className="ml-10 md:mt-5">
            <img
              className="invert inline w-[150px]"
        ...
        <div className="mt-2 ml-10 ">
          <div className="ml-5 mb-5  inline-block p-3 rounded-md ">
          ...
          <div className="ml-5 relative -top-[28px]  inline-block p-3 rounded-md ">
            <h2 className=" text-xl font-bold tracking-wider mb-2">
              ZOMAVERSE
            </h2>
            <ul className="">
          ...
          <div className="ml-5 mb-3 relative -top-[28px] inline-block p-3 rounded-md ">
            <h2 className=" text-xl font-bold tracking-wider mb-2">
              FOR RESTAURANTS
            </h2>
            <ul className="">
              ...
              <li>Apply For You</li>
              <li>
                <h2 className=" mt-2 text-xl font-bold tracking-wider mb-2">
                  FOR ENTERPISES
                </h2>
              </li>
          ...
          <div className="ml-5 sm:ml-0 relative -top-[47px]  inline-block p-3 rounded-md ">
            <h2 className=" text-xl font-bold tracking-wider mb-2">
              LEARN MORE
            </h2>
            <ul className="">
          ...
          <div className="ml-5 mr-20 relative -top-[59px] inline-block p-3 rounded-md ">
            ...
            <div className="flex flex-col -ml-1">
              <a
                className="w-[155px] mt-2"
                href="https://bnc.lt/download-zomato-ios"
              >
                <img
              ...
              <a
                className="w-[155px] mt-2"
                href="https://bnc.lt/download-z-android"
              >
                <img
        ...
        <div>
          {showGoToTop && (
            <div className="fixed bottom-7 right-7 z-10 ">
              <button
                className="shadow p-3 bg-red-500 rounded-full"
                onClick={scrollToTop}
              >
                <svg
